...
class _ListDepartmentState extends State<ListDepartment> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<DepartmentProvider>(
      builder: (context, departmentProvider, _) {
        ...
        } else if (departmentProvider.departments.isEmpty) {
          return Center(
            ...
            itemBuilder: (context, index) {
              ...
              return Column(
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      _showDialogDe(context, department);
                    },
  ...
  Future<void> _showDialogDe(BuildContext context, Department department) {
    return showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text("Thông tin chuyên khoa"),
          content: Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),
              Text(
                "Trưởng khoa: ${department.nameLeader}",
