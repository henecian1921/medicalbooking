  ...
  Widget build(BuildContext context) {
    ...
    void _submitForm(BuildContext context) async {
      if (_formKey.currentState != null && _formKey.currentState!.validate()) {
        ...
        print('Token: $token');
        print('Name of Patient: ${namePatientController.text}');//ten benh nhan
        print('Email: ${emailController.text}');
        print('Phone Number: ${phoneNumberController.text}');//sdt
        print('Selected Shift ID: $selectedShiftId');//ca kham
        print('Reason: ${reasonController.text}');//nguyen nhan
        print('CCCD: ${selectedCccd}');//cccd
        print('BHYT: ${selectedBhyt}');//bhyt
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            if (value == "") {
                              return 'Vui lòng nhập đủ họ và tên';
                            }
                            return null;
                          },
                        ),
